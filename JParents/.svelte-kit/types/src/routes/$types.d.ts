...
type LayoutRouteId = RouteId | "/" | "/resources" | "/topics" | "/topics/[index]" | "/topics/new" | "/users/[id]" | "/users/login" | "/users/registration" | null
type LayoutParams = RouteParams & { index?: string; id?: string }
